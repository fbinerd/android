...
def main():
    print("==========================================================")
    print("   DISPARANDO INICIALIZAÇÃO COMPLETA DO ANDROID 9 (v70)")
    print("==========================================================")
    ...
    try:
        ...
        print("-> Configurando variáveis de inicialização do Kernel Linux / Android 9...")
        ...
        print("-> Baixando Multi-DTB em 0x1000000 via TFTP (192.168.1.2)...")
