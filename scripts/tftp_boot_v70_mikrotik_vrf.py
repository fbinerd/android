...
def main():
    print("==========================================================")
    print("   BOOT DIRETO VIA TFTP (SERVER: 192.168.1.2 VIA MIKROTIK VRF)")
    print("==========================================================")
    ...
    try:
        ...
        print("-> Configurando endereços IP (Box: 192.168.1.139 | TFTP Server: 192.168.1.2)...")
        run_cmd("setenv ipaddr 192.168.1.139")
        run_cmd("setenv serverip 192.168.1.2")
        
        print("-> Baixando a imagem de boot v70 (16MB) do servidor TFTP 192.168.1.2...")
