...
def main():
    print("==========================================================")
    print("   DISPARANDO BOOT DO KERNEL COM ARGUMENTO DTB (0x1000000)")
    print("==========================================================")
    ...
    try:
        ...
        print("-> Baixando multi_dtb.img de 4 variantes em 0x1000000...")
        ...
        print("-> Executando bootm 0x1080000 - 0x1000000...")
        run_cmd("bootm 0x1080000 - 0x1000000", wait=2.0)
