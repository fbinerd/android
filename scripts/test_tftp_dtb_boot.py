...
def main():
    print("==========================================================")
    print("   BOOT DIRETO VIA TFTP DO /var/tftpboot (SERVER: 192.168.1.2)")
    print("==========================================================")
    ...
    try:
        ...
        print("-> [1/4] Baixando _aml_dtb.img via TFTP 192.168.1.2...")
        run_cmd("tftp 0x1000000 _aml_dtb.img")
        
        print("-> [2/4] Gravando DTB Amlogic na memória persistente...")
